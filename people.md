...
<div class="content-page">
  ...
  <div style="background: #f3e6d8; border-radius: 16px; padding: 24px; margin-bottom: 28px;">
    <div style="display: flex; flex-wrap: wrap; gap: 24px; align-items: flex-start;">
      <div style="flex: 1 1 520px; min-width: 260px;">
        <h2 style="margin-top: 0;">Debasish Das</h2>
        <p><strong>Lecturer in Applied Mathematics</strong><br>
      ...
      <div style="flex: 0 0 200px; text-align: right;">
        <img src="{{ '/images/deba_profile.jpeg' | relative_url }}" alt="Portrait of Debasish Das"
             style="width: 200px; max-width: 100%; border-radius: 16px; display: block; margin-left: auto;">
      </div>
    </div>
  </div>
  ...
  <div style="background: #f3e6d8; border-radius: 16px; padding: 24px; margin-bottom: 28px;">
    <div style="display: flex; flex-wrap: wrap; gap: 24px; align-items: flex-start;">
      <div style="flex: 1 1 520px; min-width: 260px;">
        <h2 style="margin-top: 0;">Michael McDougall</h2>
      ...
      <div style="flex: 0 0 200px; text-align: right;">
        <img src="{{ '/images/michael.jpg' | relative_url }}" alt="Photo of Michael McDougall"
             style="width: 200px; max-width: 100%; border-radius: 16px; display: block; margin-left: auto;">
      </div>
    </div>
  </div>

  <div style="background: #f3e6d8; border-radius: 16px; padding: 24px;">
    <div style="display: flex; flex-wrap: wrap; gap: 24px; align-items: flex-start;">
      <div style="flex: 1 1 520px; min-width: 260px;">
        <h2 style="margin-top: 0;">Lauren Schofield</h2>
        <p><strong>PhD Student</strong><br>
        University of Strathclyde<br>
        Since 2022</p>
      ...
      <div style="flex: 0 0 200px; text-align: right;">
        <img src="{{ '/images/lauren.jpg' | relative_url }}" alt="Photo of Lauren Schofield"
             style="width: 200px; max-width: 100%; border-radius: 16px; display: block; margin-left: auto;">
      </div>
    </div>
  </div>
